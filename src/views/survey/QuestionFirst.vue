<template>
  ...
  <div class="survey-status">
    <div class="question-stats">
      <p class="question-item">Вопрос 1/ </p>
      <p class="question-total">10</p>
    </div>
    <div class="myProgress">
      <div class="myBar" style="width: 10%"></div>
    </div>
    <div class="questions">
      <p>1.</p>
    ...
    <div class="radio-wrapper">
      <input class="radio-custom" id="radio-3" v-model="radioBox" value="3" name="radio" type="radio">
      <label for="radio-3" class="radio-label">Понравились призы от колса фортуны</label>
    </div>
...
const nextPage = ()=>{
  router.push({name: 'survey.two', params:{id: 2}})
}
</script>