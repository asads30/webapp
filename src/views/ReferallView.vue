                      ...
                      <div class="container">
                          <div class="ref-box">
                              <div class="ref-box-top">
                                  ...
                                  <div class="ref-des">Если ваш друг введет ваш промокод, вы получите +1 шанс на участие и дополнительную возможность крутить колесо фортуны. А ваш друг получит +2 шанса на участие и возможность 2 раза крутить колесо.</div>
                              </div>
                              <div class="ref-box-bottom">
                                  <div class="referall-box">
                                      <div class="referall-codebox">
                                          <div class="code-title">Ваш код приглашения</div>
                                          <input class="code-number" readonly>
                                      </div>
                                      <button class="referall-copy" @click="goCopy">
                                          <img src="@/assets/images/copy.svg" alt="">
                                          <span>Копировать</span>
                                      </button>
                                  </div>
                                  <div class="ref-invite">
                                      <button>Пригласить <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18" viewBox="0 0 19 18" fill="none" class="type2">
